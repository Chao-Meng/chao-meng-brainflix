...
function VideoDetails(props) {
  ...
  function handleAddComment(e) {
    e.preventDefault();
    //avoid submit same comment too many times
    if (isSubmitting) {
      return;
    }
    setIsSubmitting(true);
    const commentData = {
      //name should come from personal account
      name: "accountName",
      comment: newComment,
    };
    axios
      .post(
        `${props.API_URL}/videos/${props.currentVideoId}/comments`,
        commentData
      )
      .then((response) => {
    ...
    <div className="container">
        ...
        <>
          ...
          <div className="details__container">
            <div className="details__container--left">
              <p className="details__container--author">
                By {props.videoData.channel}
              </p>
              <p className="details__container--time">
                {formatTime(props.videoData.timestamp)}
              </p>
            </div>
            <div className="details__container--right">
              <div className="details__container--up">
                <img
                  className="details__container--viewImage"
                  src={views}
              ...
              <div className="details__container--down">
                <img
                  className="details__container--likeImage"
                  src={likes}
                  alt={props.videoData.title}
                ></img>
      ...
      <form className="comments" onSubmit={handleAddComment}>
        <p className="comments__title">
          {props.videoData.comments.length} Comments
        </p>
        <div className="comments__form">
          ...
          <div className="comments__form--right">
            <div className="comments__form--content">
              <label className="comments__label" htmlFor="commentsInput">
                JOIN THE VONVERSATION
              </label>
              <textarea
                name="comment"
